...
export const Navbar = () => {
                    ...
                    <defs>
                        <clipPath id="clip0_321_2061">
                            <rect
                                ...
                                height="15.3951"
                                fill="white"
                                transform="translate(0.306641 0.80957)"
                            />
                        </clipPath>
                    </defs>
                </svg>
    ...
    const getDestinationId = (destination: string): string => {
        // Map destination names to their IDs
        const destinationMap: { [key: string]: string } = {
            "Restroom": "31", // Example node ID for restroom
            "Reception": "26", // Wing Commander's office as reception
            "Exit": "5", // Main Door
            "Nurse Office": "29", // Using Cabin 1 as nurse office temporarily
            "Main Door": "5",
        };
    ...
    return (
        <div className="fixed z-20 top-10 w-full">
            <motion.div
                className="w-xl flex justify-evenly mx-auto rounded-full shadow-2xl"
                    ...
                    <div className="flex items-center gap-2">
                        {navItems.map((item) => (
                            <motion.div
                                ...
                                onClick={() =>
                                    handleNavigationRequest(item.name)
                                }
                            >
                                {item.icon}
