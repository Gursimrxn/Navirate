            ...
            >
                <div className="flex justify-between items-center gap-2 w-full max-w-lg bg-white rounded-t-4xl shadow-2xl p-6 pb-10 mx-auto">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="font-inter text-xs mt-1 text-gray-500">Popular Places</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center flex-1 mx-2">
                        ...
                        <span className="font-inter text-xs mt-1 text-black">Choose Destination</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <span className="font-inter text-xs mt-1 text-gray-500">Settings</span>
                    </div>
                </div>
            </motion.div>
        </>
